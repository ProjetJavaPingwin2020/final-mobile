 ...
 * @author TH3OMAR
 */
public class DelCatEspece extends BaseFormback{ 
    ...
    public DelCatEspece(Resources res){
       ...
       add(LayeredLayout.encloseIn(
        ...
        for (Categorie_espece E : ServiceCatEspece.getInstance().getAllCat()) {
            ...
            Button listespece  = new Button("Supprimer");
            ...
            listespece.addActionListener(e-> {
                 if (ServiceCatEspece.getInstance().del(E.getId())){
