 ...
 * @author TH3OMAR
 */
public class EspesFront extends BaseForm {

    public static TextField tnom, tadresse, tcapital, image;
    Button btnlist, btnaff;
    String path;

    public EspesFront(Resources res) {
        super("", BoxLayout.y());
        ...
        btnaff = new Button("Consulter Especes");
